...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Frameworks}: ASP.NET, .Net Core, NET Web API, ASP MVC, Umbraco, Entity Framework, WordPress, Opencart, Codeigniter, jQuery, Angular Js, TypeScript, Bootstrap
  \citembullet {\it Databases}: MySQL, SQL Server, Oracle
  \citembullet {\it Tools}:  Jenkins, Jira, MuleSoft, Confluence
  \citembullet {\it Version Control}: Git, SVN, TFS, Bitbucket
  \citembullet {\it Cloud Platforms}:Azure, Google App Engine, Amazon.
  \citembullet {\it Specialities}: Web services, Automation \& deployment, Web application development, API Development, Test Driven Development, experienced in Agile software development methodologies, Scrum methodology, CI/CD, DevOps, Solid Principles, full stack developer.
\end{category}
...
\begin{category}{Awards \&\\ Honours}
 \citem{``Fortify SCA & SSC Certified Expert''}, {\em
